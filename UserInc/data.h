...
typedef struct 
{
  ...
  MPU6050_EULER_STRUCT calibrate;
  MPU6050_EULER_STRUCT last_calibrate;
...
extern PID axis_x_circle;
extern PID axis_y_circle;
extern PID axis_x_stop;
extern PID axis_y_stop;
